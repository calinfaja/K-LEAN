...
| kln status | PASS | Rich formatted output |
| kln doctor | PASS | All checks pass |
| kln models | PASS | 18 models discovered |
| kln test | PASS | 27/27 tests pass |
| kln test-model | PASS | 0.73s latency |
| kln start | PASS | LiteLLM starts |
| kln stop | PASS | Clean shutdown |
...
# Model Test
kln test-model qwen3-coder "Say hello"
```
