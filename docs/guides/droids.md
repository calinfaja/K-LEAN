...
Specialists are defined in markdown files at `~/.factory/droids/`:
...
- Command definitions in `~/.claude/commands/kln/`
...
Create `~/.factory/droids/NEW_SPECIALIST.md`:
...
Create `~/.claude/commands/kln/databaseReview.md`:
